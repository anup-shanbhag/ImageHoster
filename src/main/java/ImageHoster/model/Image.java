...
public class Image {
	...
	// The table (primary key) is referenced by the 'image' field in the 'comments'
	// table
	// cascade = CascadeType.REMOVE specifies that if a record in 'image' table is
	// deleted, then all the records in 'comments' table associated to that
	// particular record in 'images' table will be deleted first and then the record
