...
public class ImageController {
	...
	// First receive the dynamic parameter in the incoming request URL in a integer
	// variable 'id' and also the Model type object
	// Call the getImage() method in the business logic to fetch all the details of
	// that image
	...
	// This controller method is called when the request pattern is of type
	// 'editImage'
	// If the logged in user is the same as the owner of this image then this method
	// fetches the image with the
	// corresponding id from the database and adds it to the model with the key as
	// 'image'
	...
	// If the logged is user is the same as the user who uploaded the image,then the
	// method deleteImage() in the business logic
